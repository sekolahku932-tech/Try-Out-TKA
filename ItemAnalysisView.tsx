...
// Fixed: Corrected import path from '../types' to './types' since this file is located at the root level alongside types.ts
                    ...
                    <div className="flex gap-4 items-start">
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-2">
                           <span className="text-[10px] font-black text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded border border-indigo-100 uppercase">{q.type}</span>
